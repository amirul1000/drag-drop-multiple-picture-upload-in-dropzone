...
<nav>
	<ul class="sidebar-menu" data-widget="tree">
		...
		<li <?php if($this->router->fetch_class()=="products"){?>
			class="active" <?php }?>><a
			href="<?php echo site_url('admin/products/index'); ?>"><i
				class="icon_table"></i>Products</a></li>
		<li <?php if($this->router->fetch_class()=="products_images"){?>
			class="active" <?php }?>><a
			href="<?php echo site_url('admin/products_images/index'); ?>"><i
				class="icon_table"></i>Products Images</a></li>
